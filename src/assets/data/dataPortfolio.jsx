...
const dataPortfolio = [
  {
    ...
    place: "",
    category: "forum",
    desc: "Организация питания гостей и участников Кавказского инвестиционного форума, который проходил в городе Грозном. За 3 дня было обслужено порядка 9 000 гостей.",
    cover: kifCover,
    video: "/video/kif.mp4",
    photos: [],
  },
  {
    ...
    place: "",
    category: "party",
    desc: "Организация фуршета во Дворце торжеств им. Дагуна Омаева. Финал ежегодной XIII музыкальной премии «Песня года».",
    cover: pesnyaCover,
  ...
  },
  {
    ...
    place: "",
    category: "sport",
    desc: "Организация обеда для 1 300 гостей и участников на спортивном фестивале «Техноспорт Первых» во Дворце волейбола имени Увайса Ахтаева.",
    cover: tehCover,
  ...
  },
  {
    ...
    place: "Горнолыжный комплекс «Ведучи»",
    category: "sport",
  ...
  },
  {
    ...
    place: "",
    category: "opening",
    desc: "Организация кейтеринга на презентации.",
    cover: jigitCover,
